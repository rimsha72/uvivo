                    ...
                    <div className="flex flex-col lg:flex-row lg:gap-8 gap-4">
                        ...
                        <div className="flex lg:gap-24 gap-4">
                            <div>
                                ...
                                <p className="text-gray-250 flex gap-2 mt-1">@username <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div>
                                ...
                                <p className="text-gray-250 mt-1">Active</p>
                                <p className="text-black font-semibold mt-4">Join date:</p>
                                <p className="text-gray-250 mt-1">2 Dec 2024</p>
                            </div>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4 font-semibold">
                        <button className="px-4 py-2 bg-red-150 text-white rounded-lg">Send Cash</button>
                        <button className="px-4 py-2 bg-[#FFBE0A] text-white rounded-lg">Warning</button>
                        <button className="px-4 py-2 bg-[#B74508] text-white rounded-lg">Freeze Account</button>
                        <button className="px-4 py-2 bg-[#DD2025] text-white rounded-lg">Block Account</button>
                    </div>
