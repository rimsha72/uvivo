...
export default function Order() {
    ...
    const tabs = ["Ongoing Orders", "Completed Orders", "Cancelled Orders"];
    ...
    const tabContent = {
        "Ongoing Orders": (
            <div className="border border-gray-750 rounded-lg pt-7 pb-3 drop-shadow-sm bg-white mt-4">
                <div className="flex lg:flex-row flex-col gap-4 lg:gap-6 items-center justify-between mb-7 w-full lg:px-7 px-4">
                    <h1 className="font-inter font-bold text-lg w-full">Ongoing Orders</h1>
                    ...
                    <div className="w-full flex flex-row items-end justify-end lg:gap-4 gap-2">
                        <div className="">
                            <button onClick={() => setIsOpen(true)} className="flex items-center bg-[#FCFCFC] border border-[#E7E7E7] rounded-lg lg:px-7 py-3 px-2 text-gray-250 hover:bg-gray-100">
                                <span className="mr-4 font-medium text-sm text-gray-250">Today</span>
        ...
        "Completed Orders": (
            <div className="border border-gray-750 rounded-lg pt-7 pb-3 drop-shadow-sm bg-white mt-4">
                <div className="flex lg:flex-row flex-col gap-4 lg:gap-6 items-center justify-between mb-7 w-full lg:px-7 px-4">
                    <h1 className="font-inter font-bold text-lg w-full">Completed Orders</h1>
                    <div className="w-full">
                        <form className="max-w-[427px] mx-auto w-full">
                            <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only">Search</label>
                            <div className="relative">
        ...
        "Cancelled Orders": (
            <div className="border border-gray-750 rounded-lg pt-7 pb-3 drop-shadow-sm bg-white mt-4">
                <div className="flex lg:flex-row flex-col gap-4 lg:gap-6 items-center justify-between mb-7 w-full lg:px-7 px-4">
                    <h1 className="font-inter font-bold text-lg w-full">Cancelled Orders</h1>
                    <div className="w-full">
                        <form className="max-w-[427px] mx-auto w-full">
                            <label htmlFor="default-search" className="mb-2 text-sm font-medium text-gray-900 sr-only">Search</label>
                            <div className="relative">
        ...
        <div>
            ...
            <div className="max-w-screen-3xl mx-auto">
                <div className="mx-4 sm:mx-8 my-4 space-y-4 fnt-sans">
                    <div>
                        <h1 className="font-bold text-[30px] text-gray-150">Order Management</h1>
                        <div className="grid lg:grid-cols-3 md:grid-cols-1 grid-cols-1 gap-3 mt-4">
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                                    <div>
                                        <h1 className="font-sans text-base text-gray-150">Total Order Value</h1>
                                        <p className="font-sans font-bold text-[28px] text-gray-150 mt-3">$89,000</p>
                                    </div>
                                    <img src={order} alt="" className="w-[60px] h-[60px]" />
                                </div>
                            ...
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                                    <div>
                                        <h1 className="font-sans text-base text-gray-150">Completed Orders</h1>
                                        <p className="font-sans font-bold text-[28px] text-gray-150 mt-3">10293</p>
                                    </div>
                                    <img src={completed} alt="" className="w-[60px] h-[60px]" />
                                </div>
                                <div className="flex gap-2 mt-8">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                                    <div>
                                        <h1 className="font-sans text-base text-gray-150">Pending Orders</h1>
                                        <p className="font-sans font-bold text-[28px] text-gray-150 mt-3">2040</p>
                                    </div>
                                    <img src={booking} alt="" className="w-[60px] h-[60px]" />
                                </div>
                                <div className="flex gap-2 mt-8">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M16 6L18.29 8.29L13.41 13.17L9.41 9.17L2 16.59L3.41 18L9.41 12L13.41 16L19.71 9.71L22 12V6H16Z" fill="#00B69B" />
                                    </svg>
                                    <p className="font-sans text-[13px] text-green-150">1.3% <span className="text-gray-250">Up from yesterday</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="w-full mx-auto max-w-[685px] mt-4 mb-7">
                        <div className="flex border-b border-gray-100 justify-center items-center ">
                            {tabs.map((tab) => (
                                <button
                                    key={tab}
                                    className={`flex-1 py-2 text-center text-[20px] transition-all duration-300 ${activeTab === tab ? " text-red-150 font-semibold" : "text-gray-250 "}
                                    ${activeTab !== tab ? "border-gray-100 border-b-[3px]" : " border-red-150 border-b-[2px]"}`}
