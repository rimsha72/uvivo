        ...
        <div>
            ...
            <div className="max-w-screen-3xl mx-auto">
                <div className="mx-4 sm:mx-8 my-4 space-y-4 fnt-sans">
                    <div>
                        <h1 className="font-bold text-[30px] text-gray-150">Artist Management</h1>
                        <div className="grid lg:grid-cols-4 md:grid-cols-1 grid-cols-1 gap-3 mt-4">
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                                    <div>
                                        <h1 className="font-sans text-base text-gray-150">Total Artists</h1>
                                        <p className="font-sans font-bold text-[28px] text-gray-150 mt-3">400</p>
                                    </div>
                                    <img src={users} alt="" className="w-[60px] h-[60px]" />
                                </div>
                                <div className="flex gap-2 mt-8">
                                    ...
                                    <p className="font-sans text-[13px] text-green-150">8.5% <span className="text-gray-250">Up from yesterday</span></p>
                                </div>
                            </div>
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                            ...
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                                    <div>
                                        <h1 className="font-sans text-base text-gray-150">Pending Bookings</h1>
                                        <p className="font-sans font-bold text-[28px] text-gray-150 mt-3">2040</p>
                                    </div>
                                    <img src={pending} alt="" className="w-[60px] h-[60px]" />
                                </div>
                                <div className="flex gap-2 mt-8">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M16 6L18.29 8.29L13.41 13.17L9.41 9.17L2 16.59L3.41 18L9.41 12L13.41 16L19.71 9.71L22 12V6H16Z" fill="#00B69B" />
                                    </svg>
                                    <p className="font-sans text-[13px] text-green-150">1.8% <span className="text-gray-250">Up from yesterday</span></p>
                                </div>
                            </div>
                            <div className="rounded-[14px] py-4 px-7 bg-white drop-shadow-sm">
                                <div className="flex justify-between">
                    ...
                    <div className="border border-gray-750 rounded-lg pt-7 pb-3 drop-shadow-sm bg-white mt-4">
                        <div className="flex lg:flex-row flex-col gap-4 lg:gap-6 items-center justify-between mb-7 w-full lg:px-7 px-4">
                            <h1 className="font-inter font-bold text-lg w-full">Artist Information</h1>
